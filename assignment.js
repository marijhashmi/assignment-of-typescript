...
console.log(names[3]);
//Question 12.
const name1 = ["Alice", "Bob", "Charlie", "David"];
const msg = "Hello, ";
...
//Question 13.
const transportation = ["car", "motorcycle", "bicycle", "scooter"];
...
console.log(`Dear ${DinnerGuests[2]}, you are invited to dinner. Please join us.`);
//Question 16.
let dinnerguests = ["Marie Curie", "Leonardo da Vinci"];
...
//Question 17.
const dinnerGuest = ["Marie Curie", "Leonardo da Vinci", "Isaac Newton", "Nikola Tesla", "Stephen Hawking"];
...
//Question 18.
let placesToVisit = ["Paris", "Tokyo", "Venice", "New York", "Sydney"];
...
console.log("Reverse Alphabetical Order: " + placesToVisit.slice().sort().reverse().join(', '));
//Question 19.
let dinnerguest = ["Albert Einstein", "Marie Curie", "Leonardo da Vinci"];
...
//Question 20.
let items = ["mobile", "car", "laptop", "house", "money"];
...
const new_users = ["Dave", "Alice", "Eve", "Frank", "Grace"];
...
//Question 37.
function make_largeshirt(size = "Large", message = "I love TypeScript") {
    console.log(`Shirt size: ${size}, Message: "${message}"`);
}
